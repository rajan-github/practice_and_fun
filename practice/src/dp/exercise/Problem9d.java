...
public class Problem9d {
	public static int minimumPalindromeSplitLength(String str) {
...
//		int minLengthPalindrome=str.length();
	...
	public static void main(String[] args) {
		System.out.println(minimumPalindromeSplitLength("apa"));
		System.out.println(minimumPalindromeSplitLength("BUBBASEESABANANA"));
	}
}
